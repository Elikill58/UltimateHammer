...
public class Spigot_1_19_R1 extends SpigotVersionAdapter {
	...
	public int getXpToDrop(Block b, int bonusLevel, ItemStack item) {
		...
		return blockData.getBlock().getExpDrop(blockData, obcBlock.getCraftWorld().getHandle(), obcBlock.getPosition(), CraftItemStack.asNMSCopy((org.bukkit.inventory.ItemStack) item.getDefault()), false);
	}
